<div>
    <div class="container px-5 lg:px-0 py-[70px] flex justify-between items-center flex-col-reverse lg:flex-row gap-[30px]">
            ...
            <div class="flex flex-col gap-[50px]">
                ...
                <div class="flex flex-wrap items-center gap-[30px]">
                    ...
                    <div class="flex flex-col gap-[14px] w-full sm:w-[46%]">
                        ...
                        <span class="font-bold text-lg text-opacity-75">kazan-sportclub@mail.ru</span>
                    </div>
                    <div class="flex flex-col gap-[14px] w-full sm:w-[46%]">
                        <span class="text-[14px] text-opacity-75">Адрес</span>
                        <span class="font-bold text-lg text-opacity-75">г. Казань, ул. Побежимова, д. 59</span>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full lg:w-[40%]">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8956.495055373718!2d49.07327460755681!3d55.86051907741183!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x41594d81d47728ef%3A0x8498413208111832!2z0YPQuy4g0J_QvtCx0LXQttC40LzQvtCy0LAsIDU5LCDQmtCw0LfQsNC90YwsINCg0LXRgdC_LiDQotCw0YLQsNGA0YHRgtCw0L0sIDQyMDAzNg!5e0!3m2!1sru!2sru!4v1718548169395!5m2!1sru!2sru" width="100%" height="513" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
</div>
